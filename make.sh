...
if [ $1 = "run" ]; then
	...
	venv/bin/python assets/gen_atlas.py assets/player/*.png assets/background/*/*.png --extrude=2 --py-out=src/data/atlas.py --img-out=assets/atlas.png --trim --fix-alpha
else
